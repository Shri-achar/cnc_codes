...
#define ENABLE_LIMITS         // Enables limit pin handling
#define HARD_LIMIT_ENABLE     // Stops motion if limit is triggered
#define HOMING_ENABLE         // Enables $H homing command
#define DEFAULT_STEP_PULSE_MICROSECONDS 10
#define DEFAULT_DEBOUNCE_DELAY 25     // 25 ms debounce for mechanical switches
...
#define N_AXIS 4       // Number of axes (3 to 6) ( I have set it to 4,(X,Y,Z,X), Z is unused)
